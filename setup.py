...
Can be used for installation or as a pip package
"""
...
if len(sys.argv) > 1 and sys.argv[1] in ['sdist', 'bdist_wheel', 'install', 'develop']:
    setup(
        ...
        author="freaked1234",
        author_email="",
        description="Jellyfin bandwidth management daemon with privacy-focused logging",
        long_description=read_readme(),
        long_description_content_type="text/markdown",
        url="https://github.com/freaked1234/jellydemon",
        project_urls={
            "Bug Reports": "https://github.com/freaked1234/jellydemon/issues",
            "Documentation": "https://github.com/freaked1234/jellydemon",
            "Source": "https://github.com/freaked1234/jellydemon",
        },
        ...
        entry_points={
            "console_scripts": [
                "jellydemon=jellydemon:main",
            ],
        },
        include_package_data=True,
        package_data={
            "": ["config.example.yml", "README.md", "LICENSE"],
        },
        keywords="jellyfin bandwidth management daemon streaming QoS",
        zip_safe=False,
    )
    exit(0)

# Original interactive setup script continues below...
